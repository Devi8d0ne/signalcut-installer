...
11. Launch the verified platform installer. Do not install Node.js, npm, Git, Wrangler, Python, FFmpeg, FFprobe, or browser automation; required runtime components belong in the signed SignalCut package. After SignalCut starts, direct me to its local setup screen for Codex and my own Google OAuth and YouTube configuration.
